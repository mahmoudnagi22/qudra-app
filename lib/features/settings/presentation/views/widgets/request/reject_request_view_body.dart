...
class RejectRequestViewBody extends StatelessWidget {
  const RejectRequestViewBody({super.key});
      ...
      child: Column(
        ...
        children: [
          ...
          RequestText(
            ...
            txt: S.of(context).transfer_request_rejected,
          ...
          Padding(
            ...
            child: CustomTextButton(
                text: S.of(context).resend_request, onPressed: () {}),
          ),
